...
?>
			...
			<?php if ( ! is_page_template( 'blank.php' ) ) : ?>
				...
				<div class="footer_sec fusion-footer<?php echo esc_attr( $footer_parallax_class ); ?>">
		...
		<a class="fusion-one-page-text-link fusion-page-load-link"></a>
         ...
         <!-- <div class="fixed_sos">
			<ul>
				<li><a href="#url"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/fix_sos1.png" alt="" /></a></li>
				<li><a href="#url"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/fix_sos2.png" alt="" /></a></li>
