...
$avada_default_layout = get_field('avada_default_layout'); 
if($avada_default_layout==1):
...
<?php elseif($avada_default_layout==0): 
            ...
            <div class="container">
                <div class="details_innr">
                    <div class="details_top">
                        ...
                        <span class="time_contant time_section">Date: <?php echo get_the_date('d F Y'); ?></span><br>						
                        
                        
                    </div>
                    <div class="details_center">
                        <?php the_content(); ?>
                        <span class="time_contant tag_section"><?php echo get_the_tag_list('<p><strong>Filed under:</strong> ',', ','</p>'); ?></span>
                    </div>
