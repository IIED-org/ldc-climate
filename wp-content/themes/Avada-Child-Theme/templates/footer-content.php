	...
	<footer role="contentinfo" class="fusion-footer-widget-area fusion-widget-area<?php echo esc_attr( $footer_widget_area_center_class ); ?>">
		<div class="fusion-row">
			...
			<div class="foot_bottom">
                    ...
                    <?php 
                    if(is_active_sidebar('footer-last-widget-area')): 
                        dynamic_sidebar('footer-last-widget-area');
                    endif;    
                    ?>
                    <!-- <div class="col-sm-3"><div class="foot_bottom_lt">
                            <h3>Supported by:</h3>
                   </div></div>
                    <div class="col-sm-9"><div class="foot_bottom_rt">
<ul>
<li><a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/foot_pic1.png" alt="" /></a></li>
<li><a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/foot_pic2.png" alt="" /></a></li>
<li><a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/foot_pic3.png" alt="" /></a></li>
<li><a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/foot_pic4.png" alt="" /></a></li>
</ul>
                   </div></div> -->
